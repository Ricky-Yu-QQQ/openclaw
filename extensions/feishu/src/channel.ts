  ...
  configSchema: {
    schema: {
      ...
      properties: {
        ...
        mediaAllowLocal: { type: "boolean" },
        mediaAllowedHostnames: { type: "array", items: { type: "string" } },
        mediaBlockedHostnames: { type: "array", items: { type: "string" } },
        mediaFetchTimeoutMs: { type: "integer", minimum: 1 },
        renderMode: { type: "string", enum: ["auto", "raw", "card"] },
        typingEmoji: { type: "string" },
        reactionOnReceive: { type: "string" },
        reactionOnDone: { type: "string" },
      },
    },
  },
  config: {
